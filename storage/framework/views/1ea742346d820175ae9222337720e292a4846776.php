     ...
     <?php if(count($errors)>0): ?>
  	...
  	<?php endif; ?>
        ...
        <div style="margin-right: 700px;margin-top: 30px;">
            ...
            <h5> Pedido: <?php echo e($pedido->id); ?> </h5>
            <h5> Criado em: <?php echo e($pedido->created_at->format('d/m/Y H:i')); ?> </h5>
        </div>
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            ...
                            <img style="margin: 12px;"  width="150" height="150" src="<?php echo e(url('img/produtos/'.md5($pedido_produto->produto->id).'.jpg')); ?>" alt="Imagem Produto" class="img-fluid img-thumbnail">
                        </td>
            ...
            <div class="row" style="margin-left: 500px;font-size: 20px;color: green;">
                ...
                <span > € <?php echo e(number_format($total_pedido, 2, ',', '.')); ?></span>
            </div>
            ...
            <div class="row">
                <a class="btn-large tooltipped col l4 s4 m4 offset-l2 offset-s2 offset-m2"  style="margin:30px;" href="<?php echo e(route('home')); ?>"><button class="btn btn-danger">Continuar Comprando</button></a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vagrant/Sites/projetoPap/resources/views/carrinho/index.blade.php ENDPATH**/ ?>